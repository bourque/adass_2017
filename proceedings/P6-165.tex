...
\articlefiguretwo{P6-165_f4a.eps}{P6-165_f4b.eps}{fig4}{The Quicklook webpage for performing a database query (\emph{left}) and the webpage showing the results of the query (\emph{right}).}
